...
/*!************************************************************!*\
  ...
  \************************************************************/
/*! no static exports found */function(e,t,n){n(/*! /Users/mitra/Library/Caches/Yarn/v6/.tmp/f85d5c6dbf48ced4703e8bc19ab1e947.5c04a7b880a402fa16e48933f5ca7327747203dc.prepare/src/scripts/index.js */"./src/scripts/index.js"),e.exports=n(/*! /Users/mitra/Library/Caches/Yarn/v6/.tmp/f85d5c6dbf48ced4703e8bc19ab1e947.5c04a7b880a402fa16e48933f5ca7327747203dc.prepare/src/styles/index.less */"./src/styles/index.less")}})},function(e,t,n){"use strict";Object.defineProperty(t,"__esModule",{value:!0});var a,i=n(4),o=(a=i)&&a.__esModule?a:{default:a};function r(e,t){var n=e.querySelector("output");n||((n=document.createElement("output")).setAttribute("role","alert"),e.appendChild(n)),n.textContent="",n.textContent=t}function s(e){e.querySelector("input")&&(e.appendChild(function(e){var t=document.createElement("button");return t.type="button",t.textContent="Copy",t.title="Copy to clipboard",t.setAttribute("data-clipboard-target","#"+e.querySelector("input").id),t}(e)),e.setAttribute("data-copyable-text-ready",""))}t.default=function(){var e,t=document.querySelectorAll("[data-copyable-text]:not([data-copyable-text-ready])");t.length<=0||o.default.isSupported()&&([].concat(function(e){if(Array.isArray(e)){for(var t=0,n=Array(e.length);t<e.length;t++)n[t]=e[t];return n}return Array.from(e)}(t)).forEach(s),(e=new o.default("[data-copyable-text] [data-clipboard-target]")).on("success",(function(e){var t=e.trigger.parentElement,n=t.getAttribute("data-copyable-text-success-message")||"Text copied to clipboard.";r(t,n)})),e.on("error",(function(e){var t=e.trigger.parentElement,n=t.getAttribute("data-copyable-text-error-message")||"Something went wrong.";r(t,n)})))}},function(e,t,n){
/*!
 * clipboard.js v2.0.4
