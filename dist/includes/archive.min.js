...
/*!************************************************************!*\
  ...
  \************************************************************/
/*! no static exports found */function(e,t,n){n(/*! /Users/mitra/.npm/_cacache/tmp/git-clone-55659320/src/scripts/index.js */"./src/scripts/index.js"),e.exports=n(/*! /Users/mitra/.npm/_cacache/tmp/git-clone-55659320/src/styles/index.less */"./src/styles/index.less")}})},function(e,t,n){"use strict";Object.defineProperty(t,"__esModule",{value:!0});var a=function(e){return e&&e.__esModule?e:{default:e}}(n(4));function i(e,t){var n=e.querySelector("output");n||((n=document.createElement("output")).setAttribute("role","alert"),e.appendChild(n)),n.textContent="",n.textContent=t}function o(e){e.querySelector("input")&&(e.appendChild(function(e){var t=document.createElement("button");return t.type="button",t.textContent="Copy",t.title="Copy to clipboard",t.setAttribute("data-clipboard-target","#"+e.querySelector("input").id),t}(e)),e.setAttribute("data-copyable-text-ready",""))}t.default=function(){var e=document.querySelectorAll("[data-copyable-text]:not([data-copyable-text-ready])");e.length<=0||a.default.isSupported()&&([].concat(function(e){if(Array.isArray(e)){for(var t=0,n=Array(e.length);t<e.length;t++)n[t]=e[t];return n}return Array.from(e)}(e)).forEach(o),function(){var e=new a.default("[data-copyable-text] [data-clipboard-target]");e.on("success",function(e){var t=e.trigger.parentElement;i(t,t.getAttribute("data-copyable-text-success-message")||"Text copied to clipboard.")}),e.on("error",function(e){var t=e.trigger.parentElement;i(t,t.getAttribute("data-copyable-text-error-message")||"Something went wrong.")})}())}},function(e,t,n){
/*!
 * clipboard.js v2.0.1
