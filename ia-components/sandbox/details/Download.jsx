...
class DownloadDirectoryDiv extends React.Component {
  /**
   * <Download
   ...
   * https://github.com/internetarchive/dweb-archivecontroller/issues/8 for better algorithm for reachable, and probably apply at ArchiveItem level when getting list
   */
          ...
          <pre>
            <table className="directory-listing-table">
              ...
              <tbody>
                <tr>
                  <td>
                    <AnchorDetails identifier={this.props.identifier}>
                      <span
                        className="iconochive-Uplevel"
                        title={I18nStr('Parent Directory')}
                        aria-hidden="true"
                      />
                      {' '}
                      <I18nSpan en="Go to item page" />
                    </AnchorDetails>
                  </td>
                  <td />
                  <td />
                ...
                {this.props.files
                  ...
                  .map(f => (
                    <tr key={f.name}>
                      ...
                      <td>
                        {f.size}
                        {/* --TODO-DIR should be "-" for directory--*/}
                      </td>
                    </tr>
                  ))}
              </tbody>
